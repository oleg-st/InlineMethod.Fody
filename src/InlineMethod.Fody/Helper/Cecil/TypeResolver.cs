...
namespace InlineMethod.Fody.Helper.Cecil
{
	/**
	 * Source
	 * https://github.com/jbevain/cecil/blob/master/Mono.Cecil/TypeResolver.cs
	 */
	internal sealed class TypeResolver
	{
		...
		private TypeReference ResolveGenericParameter(GenericParameter genericParameter)
		{
			...
			return genericParameter.Type == GenericParameterType.Type
				? (_typeDefinitionContext != null ? _typeDefinitionContext.GenericArguments[genericParameter.Position] : genericParameter)
